...
| Document | Description |
|----------|-------------|
| **[UNSTUCK_ALGORITHM.md](UNSTUCK_ALGORITHM.md)** | Detailed unstuck recovery algorithm |
| **[SELF_AVOIDING_DESIGN.md](SELF_AVOIDING_DESIGN.md)** | Self-avoiding walk design and implementation |
