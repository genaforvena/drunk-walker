...
// Built: 2026-03-23T00:48:18.032Z
// ═══════════════════════════════════════════════════════════════════════════════
 ...
 */
function createAutosaver(engine, algorithm, config = {}) {
...
const __default_export = createAutosaver;
...
const __default_export = createExperimentConfig;
 ...
 */
function createDataExporter(engine, algorithm) {
...
const __default_export = createDataExporter;
 ...
 */
function createExperimentMonitor(engine, algorithm, config = {}) {
...
const __default_export = createExperimentMonitor;
 ...
 */
function createExperiment(engine, algorithm) {
  // Create sub-modules
  const autosaver = createAutosaver(engine, algorithm);
  const config = createExperimentConfig();
  const exporter = createDataExporter(engine, algorithm);
...
const __default_export = createExperiment;
